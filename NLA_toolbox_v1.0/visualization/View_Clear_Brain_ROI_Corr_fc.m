function pairsOut=View_Clear_Brain_ROI_Corr_fc(Anat,IM,M,dataOut,fc,Pmax,params)
%
...
if iscell(fc)
FC.tp1=cat(3,fc{1},fc{3});
FC.tp2=cat(3,fc{2},fc{4});
else
    FC.tp1=fc;
end
clear fc
...
for j=1:NnnSig
    ...
    for ts=1 % expand to include multiple time points...
    pairsOut{j,ts}=[];    
